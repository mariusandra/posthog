...
import type { CustomerAnalyticsConfig } from '../../../frontend/src/queries/schema/schema-general'
...
export interface customerAnalyticsSceneLogicValues {
    activityEvent: AnyEntityNode // customerAnalyticsConfigLogic
    customerAnalyticsConfig: CustomerAnalyticsConfig // customerAnalyticsConfigLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface customerAnalyticsSceneLogicActions {
...
export interface customerAnalyticsSceneLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        activeTab: (sceneKey: string | undefined) => ActiveTab
        customerLabel: (
        ...
        groupOptions: (groupTypesRaw: GroupType[]) => {
            label: string
            value: number
        }[]
        dauSeries: (
...
export type customerAnalyticsSceneLogicType = MakeLogicType<
    customerAnalyticsSceneLogicValues,
    customerAnalyticsSceneLogicActions,
    Record<string, any>,
    customerAnalyticsSceneLogicMeta
>
