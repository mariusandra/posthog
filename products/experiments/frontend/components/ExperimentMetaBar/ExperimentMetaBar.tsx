...
export function ExperimentMetaBar({ tabId }: { tabId?: string }): JSX.Element | null {
    ...
    return (
        <div className="flex flex-col gap-2 -mt-2" data-attr="experiment-meta-bar">
            ...
            {visibility.showRemainingTime && <RunningTimeConfigModal experiment={experiment} tabId={tabId} />}
        </div>
    )
}
