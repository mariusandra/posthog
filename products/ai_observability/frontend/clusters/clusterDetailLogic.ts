...
export interface clusterDetailLogicValues {
    ...
    filteredItemIdsLoading: boolean
    ...
    unfilteredTotalTraces: number
    windowEnd: string
    windowStart: string
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface clusterDetailLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface clusterDetailLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        ...
        hasActiveFilters: (propertyFilters: AnyPropertyFilter[], shouldFilterTestAccounts: boolean) => boolean
...
export type clusterDetailLogicType = MakeLogicType<
    clusterDetailLogicValues,
    clusterDetailLogicActions,
    ClusterDetailLogicProps,
    clusterDetailLogicMeta
>
    ...
    selectors({
            ...
            (cluster: Cluster | null, isOutlier: boolean): ClusterScatterSeries[] => {
                ...
                if (!isOutlier) {
                    result.push({
                        ...
                        pointRadius: 10,
                        shape: 'circle',
                        points: [{ x: cluster.centroid_x, y: cluster.centroid_y, meta: { isCentroid: true } }],
                    })
                }
        ...
        breadcrumbs: [
            ...
            (cluster: Cluster | null, runId: string): Breadcrumb[] => [
                ...
                {
                    key: 'AIObservabilityClustersRun',
                    name: dayjs(runId.split('_')[1] || runId).isValid()
                        ? dayjs(runId.split('_')[1] || runId).format('MMM D, YYYY')
                        : 'Run',
                    path: urls.aiObservabilityClusters(runId),
                    iconType: 'llm_clusters',
                },
                {
                    key: 'AIObservabilityCluster',
