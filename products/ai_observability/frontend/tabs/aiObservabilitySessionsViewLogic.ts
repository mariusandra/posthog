...
export interface aiObservabilitySessionsViewLogicValues {
    ...
    getSessionTitle: (sessionId: string) => string | null | undefined // llmSessionTitleLazyLoaderLogic
...
export interface aiObservabilitySessionsViewLogicActions {
    applyUrlState: (
        state: import('../aiObservabilitySharedLogic').ApplyUrlStatePayload
    ) => import('../aiObservabilitySharedLogic').ApplyUrlStatePayload // aiObservabilitySharedLogic
    setDates: (
        dateFrom: string | null,
        dateTo: string | null
    ) => {
    ...
    loadSessions: (payload?: { refresh?: RefreshType }) => {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface aiObservabilitySessionsViewLogicMeta {
    key: string
...
export type aiObservabilitySessionsViewLogicType = MakeLogicType<
    aiObservabilitySessionsViewLogicValues,
    aiObservabilitySessionsViewLogicActions,
    AIObservabilitySessionsViewLogicProps,
    aiObservabilitySessionsViewLogicMeta
>
