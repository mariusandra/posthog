...
export interface aiObservabilityTracesTabLogicValues {
    dateFilter: {
        dateFrom: string | null
        dateTo: string | null
    } // aiObservabilitySharedLogic
    propertyFilters: AnyPropertyFilter[] // aiObservabilitySharedLogic
    searchQuery: string // aiObservabilitySharedLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface aiObservabilityTracesTabLogicActions {
    setShowInputOutputColumns: (show: boolean) => {
        show: boolean
    }
    setShowSentimentColumn: (show: boolean) => {
        show: boolean
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface aiObservabilityTracesTabLogicMeta {
    key: string
...
export type aiObservabilityTracesTabLogicType = MakeLogicType<
    aiObservabilityTracesTabLogicValues,
    aiObservabilityTracesTabLogicActions,
    AIObservabilityTracesTabLogicProps,
    aiObservabilityTracesTabLogicMeta
>
