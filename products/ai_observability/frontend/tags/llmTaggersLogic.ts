...
export interface llmTaggersLogicValues {
    dateFilter: {
    ...
    >
    taggers: Tagger[]
    taggersFilter: string
    taggersLoading: boolean
    totalRuns: number
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface llmTaggersLogicActions {
    setDates: (
        dateFrom: string | null,
        dateTo: string | null
    ) => {
    ...
    toggleTaggerEnabled: (id: string) => {
        id: string
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface llmTaggersLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        filteredTaggers: (taggers: Tagger[], taggersFilter: string) => Tagger[]
        runStatsMap: (runStats: TaggerRunStats[]) => Record<string, number>
        tagDistributionMap: (tagCounts: TaggerTagCount[]) => Record<
            string,
            Array<{
                name: string
                percent: number
        ...
        >
        totalRuns: (runStats: TaggerRunStats[]) => number
        chartQuery: (
            taggers: Tagger[],
            dateFilter: {
                dateFrom: string | null
...
export type llmTaggersLogicType = MakeLogicType<
    llmTaggersLogicValues,
    llmTaggersLogicActions,
    LLMTaggersLogicProps,
    llmTaggersLogicMeta
>
