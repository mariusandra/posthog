...
export interface endpointsUsageLogicValues {
    allEndpoints: EndpointType[] // endpointsLogic
    allEndpointsLoading: boolean // endpointsLogic
    activeEndpointNames: Set<string>
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface endpointsUsageLogicActions {
    clearCooldown: () => {
        value: true
    }
    refresh: () => {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface endpointsUsageLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        endpointNames: (allEndpoints: EndpointType[]) => string[]
        activeEndpointNames: (endpointNames: string[]) => Set<string>
        endpointNamesLoading: (allEndpointsLoading: boolean) => boolean
        canRefresh: (cooldownActive: boolean) => boolean
...
export type endpointsUsageLogicType = MakeLogicType<
    endpointsUsageLogicValues,
    endpointsUsageLogicActions,
    EndpointsUsageLogicProps,
