...
export function personViewedProperties(person: PersonType, postHogPropertyKeys: string[]): Record<string, unknown> {
    const keys = Object.keys(person.properties ?? {})
    const posthog_properties_count = keys.filter((key) => postHogPropertyKeys.includes(key)).length
    return {
        properties_count: keys.length,
        has_email: !!person.properties?.email,
        has_name: !!person.properties?.name,
        custom_properties_count: keys.length - posthog_properties_count,
        posthog_properties_count,
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface personsLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface personsLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface personsLogicMeta {
    key: string
...
export type personsLogicType = MakeLogicType<
    personsLogicValues,
    personsLogicActions,
    PersonsLogicProps,
    personsLogicMeta
...
export const personsLogic = kea<personsLogicType>([
    ...
    connect(() => ({
        actions: [eventUsageLogic, ['reportPersonPropertyUpdated']],
    ...
    selectors(() => ({
        ...
        currentTab: [
            (s) => [s.activeTab, s.defaultTab],
            (activeTab: PersonsTabType | null, defaultTab: PersonsTabType.PROFILE | PersonsTabType.PROPERTIES) =>
        ...
        primaryDistinctId: [
            (s) => [s.person],
            (person: PersonType | null): string | null => pickBestPersonDistinctId(person?.distinct_ids) ?? null,
        ],
        eventsQueryIsDirty: [
            (s) => [s.eventsQuery, s.person],
            (eventsQuery: DataTableNode | null, person: PersonType | null): boolean => {
