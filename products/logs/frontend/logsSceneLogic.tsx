...
export const logsSceneLogic = kea<logsSceneLogicType>([
    ...
    connect((props: LogsLogicProps) => ({
        actions: [
            logsViewerFiltersLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['setFilters'],
            logsFilterHistoryLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['pushToFilterHistory'],
            logsViewerConfigLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['setOrderBy', 'setViewMode', 'setGroupBys', 'addGroupBy', 'removeGroupByAt', 'replaceGroupByAt'],
            logsViewerDataLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['setInitialLogsLimit', 'fetchLogsSuccess', 'handleQueryChange'],
            logsViewerLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['setLinkToLogId', 'clearLinkToLogId'],
            logDetailsModalLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['closeLogDetails'],
            facetRailLogic({ id: props.tabId || LOGS_SCENE_VIEWER_ID }),
            ['setFacetNameSearch'],
            logsAnomaliesLogic,
