...
export interface dashboardsModelValues {
    ...
    pinSortedDashboards: (DashboardBasicType | DashboardType)[]
    pinnedDashboards: (DashboardBasicType | DashboardType)[]
...
export interface dashboardsModelActions {
    ...
    tileRemovedFromDashboard: ({ tile, dashboardId }: { dashboardId?: number; tile?: DashboardTile }) => {
...
export interface dashboardsModelMeta {
    __keaTypeGenInternalSelectorTypes: {
        nameSortedDashboards: (
            rawDashboards: Record<string, DashboardBasicType | DashboardType>
        ) => (DashboardBasicType | DashboardType)[]
        pinSortedDashboards: (
            nameSortedDashboards: (DashboardBasicType | DashboardType)[]
        ) => (DashboardBasicType | DashboardType)[]
...
export const dashboardsModel = kea<dashboardsModelType>([
    ...
    actions(() => ({
         ...
         */
        updateDashboardInsight: (insight: InsightModel, extraDashboardIds?: number[], sourceDashboardId?: number) => ({
            insight,
            extraDashboardIds,
            sourceDashboardId,
        }),
        ...
        tileMovedToDashboard: (tile: DashboardTile, dashboardId: number) => ({
            tile,
            dashboardId,
        }),
            ...
            null as PaginatedResponse<DashboardBasicType> | null,
            {
                loadDashboards: async (url?: string) => {
                    ...
                    if (!teamLogic.values.currentTeam) {
                        // Retry when the team arrives so consumers do not cache an empty list for the session.
