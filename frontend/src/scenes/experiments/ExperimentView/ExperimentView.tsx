...
import {
    ...
    type ExperimentTab,
    type ExperimentSceneLogicProps,
    experimentSceneLogic,
} from '../experimentSceneLogic'
...
export function ExperimentView({ tabId }: Pick<ExperimentSceneLogicProps, 'tabId'>): JSX.Element {
    ...
    const { activeTabKey, availableTabs } = useValues(experimentSceneLogic({ tabId }))
