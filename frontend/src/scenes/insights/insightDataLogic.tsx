...
export const isInsightSceneInstance = (props: InsightLogicProps): boolean => {
    ...
    const sceneValues = insightSceneLogic.findMounted({ tabId: sceneLogic.values.activeTabId ?? undefined })?.values
    return (
...
export const insightDataLogic = kea<insightDataLogicType>([
    ...
    listeners(({ actions, cache, values, props }) => ({
        ...
        setQuery: ({ query }) => {
            ...
            if (isInsightSceneInstance(props) && props.tabId && sceneLogic.values.activeTabId === props.tabId) {
