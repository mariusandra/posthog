...
describe('panelLayoutLogic', () => {
    ...
    it('maps the legacy desktop apps tab to the shared home tab', () => {
        panelLayoutLogic.actions.setNavExperimentTab('apps')
        expect(panelLayoutLogic.values.navExperimentActiveTab).toBe('home')
        expect(panelLayoutLogic.values.visitedNavTabs).toContain('home')
    })
