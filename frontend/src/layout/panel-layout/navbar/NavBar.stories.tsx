...
export const DesktopNavigation: StoryObj = {
    parameters: { layout: 'fullscreen' },
    beforeEach: () => {
        const previous = window.__POSTHOG_DESKTOP__
        window.__POSTHOG_DESKTOP__ = { version: '0.3.2', platform: 'darwin' }
        return () => {
            window.__POSTHOG_DESKTOP__ = previous
        }
    },
    render: () => (
        <div className="app-layout--desktop-tabs app-layout--desktop-mac flex h-screen overflow-hidden [--project-navbar-width:300px]">
            <NavBar />
