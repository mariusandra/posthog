...
export const Desktop: Story = {
    beforeEach: () => {
        const previous = window.__POSTHOG_DESKTOP__
        window.__POSTHOG_DESKTOP__ = { version: '2026.9.1', platform: 'darwin' }
        return () => {
            window.__POSTHOG_DESKTOP__ = previous
        }
    },
}
export const DesktopFiles: Story = { ...Desktop, args: { tab: 'files' } }
export const DesktopCode: Story = { ...Desktop, args: { tab: 'code' } }
export const DesktopCollapsed: Story = { ...Desktop, args: { collapsed: true } }
export const DesktopNarrow: Story = { ...Desktop, decorators: Narrow.decorators }
